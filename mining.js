...
return new Block(0, "09/06/2023", "Genesis Block","0");
}
getLatestBlock(){
...
let AMCoin = new mining();
console.log("*****Cryptocurrency Transaction Process*****");
console.log("Mining Block 1...");
AMCoin.addBlock(new Block(1,"08/08/2023",{amount : 6}));
console.log("Mining Block 2...");
AMCoin.addBlock(new Block(2,"09/09/2023",{amount : 10}));
