...
{(byte)'H',(byte)'e',(byte)'l',(byte)'l',(byte)'o',(byte)' ',(byte)'F',(byte)'i',(byte)'d',(byte)'e',(byte)'s',(byte)'m',(byte)'o',(byte)'!'};
...
Util.arrayCopyNonAtomic(helloFidesmo, (short)0, buffer, (short)0, 
(short)length);
